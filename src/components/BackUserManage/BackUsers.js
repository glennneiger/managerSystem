...
const ItemEditForm = Form.create()(
    (props) => {
        const {visible, onCancel, onCreate, form, data, onChangeOrg, handleChange, handleSearch, orgList, departmentList, roleList, confirmLoading} = props;
        const {getFieldDecorator} = form;
...
class DataTable extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            pagination: {
                current: 1,
                pageSize: Number(localStorage.backUserSize) || 10,
                    ...
                    if (json.data) {
                        ...
                        json.data.list.forEach((item, index) => {
                            ...
                            data.push({
                                ...
                                name: item.username,                                
                                gender: tempGender,
                                department: item.departmentName || "暂无",
                                role: item.roleName || "暂无",
