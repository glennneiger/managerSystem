        ...
        return (
            <div className="category-add category-form user-detail-form">
                ...
                <div className="form-footer">
                    <Button type="primary" onClick={onCreate}>确定</Button>
...
class ItemEdit extends Component {
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            console.log(Date.parse(new Date(values.birthday)));
            console.log(typeof(Date.parse(new Date(values.birthday))));
            const result = {
