            ...
            success: (json) => {
                if (json.result === 0) {
                    ...
                    this.setState({
                        ...
                        photo: json.data.photoList.length ? json.data.photoList[0].photo : ''
                    });
                } else {
                    if (json.code === 901) {
                        message.error("请先登录");
                ...
                render: (text, record) => {
                    return (
                        <div className="editable-row-operations">
                            ...
                            {/*问题编辑*/}
                            {/*<ItemEdit id={record.id} toLoginPage={this.props.toLoginPage}
                                         opStatus={this.props.opObj.select}/>*/}
                            {/*问题删除*/}
                            <Popconfirm title="确认删除?"
                                        placement="topRight"
                ...
                if (json.result === 0) {
                    ...
                    json.data.list.forEach((item, index) => {
                        ...
                        data.push({
                            ...
                            photo: item.photoList.length ? (item.photoList[0].photo) : "",
