...
const ItemAddForm = Form.create()(
    (props) => {
        const {checkPhone, checkTel, beforeUpload03, reqwestUploadToken, visible, onCancel, onCreate, form, provinceList, cityList, districtList, streetList, markers, setMarkers, area, setArea, mapObj, setXY, setFormattedAddress, formattedAddress, setPhone, photoList01, setPhotoList01, viewPic02, effectPic02, data_pic02, setViewPic02, picUpload02, avatarEditor02, setAvatarEditor02, logoLoading, confirmLoading} = props;
                    ...
                    return (
                        <div className="editable-row-operations">
                            ...
                            {/*<Popconfirm 
                                ...
                                cancelText="取消">
                                {
                                    <a style={{display: this.props.opObj.banOrg && record.statusCode === 2 ? "inline" : "none"}}>禁用</a>
                                }
                            </Popconfirm>*/}
                            {/*公司启用*/}
                            {/*<Popconfirm title="确认启用?"
                                        ...
                                        cancelText="取消">
                                {
                                    <a style={{display: this.props.opObj.banOrg && record.statusCode === 0 ? "inline" : "none"}}>启用</a>
                                }
                            </Popconfirm>*/}
                            <ShopSave 
                                id={record.id} 
