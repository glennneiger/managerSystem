...
const ItemEditForm = Form.create()(
    (props) => {
        const {opStatus, checkPhone, checkTel, onChangeFile, fileList, defaultFileList, beforeUpload03, editCompany, readlyOnly, onCancel, onCreate, setPhone, form, data, reqwestUploadToken, viewPic02, setViewPic02, data_pic02, effectPic02, picUpload02, avatarEditor02, setAvatarEditor02, logoLoading, provinceList, cityList, districtList, streetList, markers, setMarkers, area, setArea, mapObj, setXY, setFormattedAddress, formattedAddress} = props;
