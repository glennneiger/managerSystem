                ...
                <div className="financial-manage">
                    <Layout>
                        <Sider width={200} style={{background: '#fff'}}>
                            ...
                            >
                                <SubMenu key="sub1" title={<span><Icon type=""/>财务管理</span>}>
                                    {this.state.menuList}
                                    {/*<Menu.Item key="1" style={{textAlign: "center"}}>
                                        <Link to="/index/financial-manage/bank">
                                            收款银行卡
                                        </Link>
                                    </Menu.Item> */}
                                    {/*<Menu.Item key="9" style={{textAlign: "center"}}>
                                        <Link to="/index/financial-manage/settle-accounts-manage">
                                            结算管理
                                        </Link>
                                    </Menu.Item>*/}
                                    {/*<Menu.Item key="10" style={{textAlign: "center"}}>
                                        <Link to="/index/financial-manage/order-detail">
                                            账单详情
                                        </Link>
                                    </Menu.Item> */}                                   
                                </SubMenu>
                               {/* <SubMenu key="sub2" title={<span><Icon type=""/>平台</span>}>
                                    <Menu.Item key="11" style={{textAlign: "center"}}>
                                        <Link to="/index/financial-manage/settle">
                                            结算管理
                                        </Link>
                                    </Menu.Item>
                                </SubMenu>
                                <SubMenu key="sub3" title={<span><Icon type=""/>机构</span>}>
                                    <Menu.Item key="12" style={{textAlign: "center"}}>
                                        <Link to="/index/financial-manage/org-settle">
                                            结算管理
                                        </Link>
                                    </Menu.Item>
                                </SubMenu>*/}
