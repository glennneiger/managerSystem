                                    ...
                                    <Col span={8}>
                                         <FormItem className="typeId" label="所属科目：">
                                            {getFieldDecorator('typeId', {
                                                initialValue: data.parentTypeId && data.typeId ? [data.parentTypeId, data.typeId] : undefined,
                                                rules: [{
                                                    required: true,
                                                    message: '科目不能为空',
                                                }],
        ...
        return (
            ...
            <a >
                ...
                <ItemEditForm
                    ...
                    // studentType={this.state.studentTypeTemp}
                ...
                if (json.result === 0) {
                    ...
                    json.data.list.forEach((item, index) => {
                        ...
                        data.push({
                            ...
                            createUserName: item.createUser || "暂无",
