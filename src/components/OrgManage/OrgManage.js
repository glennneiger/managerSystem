                ...
                <div className="institution-manage">
                    <Layout>
                        <Sider width={200} style={{background: '#fff'}}>
                            ...
                            >
                                <SubMenu key="sub1" title={<span><Icon type=""/>机构管理</span>}>
                                    {this.state.menuList}
                                </SubMenu>
                            </Menu>
                        </Sider>
                        <Layout style={{padding: '24px'}}>
                            <Content style={{background: '#fff', padding: "24px 24px 0", margin: 0, minHeight: 406}}>
                                ...
                                <Route path="/index/org-manage/teachers-one" component={TeachersOne}/>
                                <Route path="/index/org-manage/courses-one" component={CoursesOne}/>
							</Content>
                        </Layout>
                    </Layout>
                </div>
